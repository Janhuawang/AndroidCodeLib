...
import baselib.widget.banner.BannerScroller;
import baselib.widget.banner.WeakHandler;
import baselib.widget.banner.listener.OnBannerClickListener;
import baselib.widget.banner.loader.ImageLoaderInterface;
import baselib.widget.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mLayoutResId = R.layout.widget_banner;
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    public Banner setOnBannerListener(OnBannerClickListener listener) {
            ...
            if (clickListener != null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        clickListener.OnBannerClick(toRealPosition(position));
                    }
                });
            }
            return view;
