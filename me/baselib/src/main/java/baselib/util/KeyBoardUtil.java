...
public class KeyBoardUtil {
    ...
    public static void hideSoftInputFromWindow(Activity activity) {
        ((InputMethodManager) activity.getSystemService(Activity.INPUT_METHOD_SERVICE))
                .hideSoftInputFromWindow(activity.getWindow().getDecorView().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
    }
     ...
     * @return
     */
    public static boolean isSoftInputFromWindow(Context context, EditText editText) {
        return ((InputMethodManager) context.getSystemService(Activity.INPUT_METHOD_SERVICE)).isActive(editText);
    }
